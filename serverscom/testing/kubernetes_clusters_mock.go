...
//
//	mockgen --destination ./serverscom/testing/kubernetes_clusters_mock.go --package=serverscom_testing --source ./vendor/github.com/serverscom/serverscom-go-client/pkg/kubernetes_clusters.go
//
