...
//
//	mockgen --destination ./serverscom/testing/collection_mock.go --package=serverscom_testing --source ./vendor/github.com/serverscom/serverscom-go-client/pkg/collection.go
//
