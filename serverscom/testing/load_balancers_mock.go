...
//
//	mockgen --destination ./serverscom/testing/load_balancers_mock.go --package=serverscom_testing --source ./vendor/github.com/serverscom/serverscom-go-client/pkg/load_balancers.go
//
